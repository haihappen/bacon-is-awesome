...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baconjs = __webpack_require__(81);
	...
	var App = (function (_Component) {
	  function App(props) {
	    ...
	    this.state = { stream: new _baconjs.Bus() };
	  }
	  ...
	  App.prototype.render = function render() {
	    ...
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement(TextInput, { stream: this.state.stream }),
	      _react2['default'].createElement(Label, { stream: this.state.stream }),
	      _react2['default'].createElement(InvertedLabel, { stream: this.state.stream })
	    );
	  };
	...
	var TextInput = (function (_Component2) {
	  ...
	  TextInput.prototype.handleChange = function handleChange() {
	    var text = _react2['default'].findDOMNode(this.refs.input).value;
	  ...
	  _createClass(TextInput, null, [{
	    key: 'propTypes',
	    value: {
	      stream: _react.PropTypes.instanceOf(_baconjs.Bus).isRequired
	    },
	    enumerable: true
	  }]);
	...
	var Label = (function (_React$Component) {
	  ...
	  Label.prototype.componentWillMount = function componentWillMount() {
	    var _this2 = this;

	    this.props.stream.toProperty('').onValue(function (text) {
	...
	var InvertedLabel = (function (_Label) {
	  function InvertedLabel() {
	    _classCallCheck(this, InvertedLabel);

	    if (_Label != null) {
	      _Label.apply(this, arguments);
	    }
	  }

	  _inherits(InvertedLabel, _Label);

	  InvertedLabel.prototype.componentWillMount = function componentWillMount() {
	    var _this3 = this;
	    ...
	    this.props.stream.map(reverse).toProperty('').onValue(function (text) {
	      _this3.setState({ text: text });
	    });
	  };

	  _createClass(InvertedLabel, null, [{
	    key: 'propTypes',
	    value: {
	      stream: _react.PropTypes.instanceOf(_baconjs.Bus).isRequired
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (("function" !== "undefined" && __webpack_require__(4) !== null) && (__webpack_require__(5) != null)) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function() {
	      return Bacon;
	    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    this.Bacon = Bacon;
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(7), __webpack_require__(6)(module)))
