...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baconjs = __webpack_require__(80);
	...
	var App = (function (_Component) {
	  function App(props) {
	    ...
	    this.state = { text: new _baconjs.Bus() };
	  }
	  ...
	  App.prototype.render = function render() {
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement(TextInput, { text: this.state.text }),
	      _react2['default'].createElement(Label, { text: this.state.text }),
	      _react2['default'].createElement(InvertedLabel, { text: this.state.text })
	    );
	  };
	...
	var TextInput = (function (_Component2) {
	  ...
	  _createClass(TextInput, null, [{
	    key: 'propTypes',
	    value: {
	      text: _react.PropTypes.instanceOf(_baconjs.Bus).isRequired
	    },
	    enumerable: true
	  }]);
	...
	var Label = (function (_React$Component) {
	  ...
	  Label.prototype.componentWillMount = function componentWillMount() {
	    ...
	    this.props.text.toProperty('').onValue(function (text) {
	...
	var InvertedLabel = (function (_Label) {
	  ...
	  InvertedLabel.prototype.componentWillMount = function componentWillMount() {
	    ...
	    this.props.text.map(reverse).toProperty('').onValue(function (text) {
